  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <View  style={{ width: '90%', marginTop:6, marginBottom:'25%' }}>
          ...
          <Card key={product.id}>
            <CardItem >
              <Body style={{ flexDirection: 'row', width: '100%' }}>
                <View style={{ width: '45%' }}>
                  <Image source={product.uri} style={{ height: 120, width: 150 }} />
                </View>
                <View style={{ width: '55%', height: '100%', flex: 1, }}>
                  <View style={{height:90 }}>
                    <Text style={{ fontSize: 18, fontWeight: 'bold', marginTop: 3 }}>{product.title}</Text>
                    <Text style={{ fontSize: 13 }}>{product.desc}</Text>
                  </View>
                  <View style={{ width: '100%', height: 30, flexDirection: 'row', alignItems: 'flex-end' }}>
                    <View style={{ width: '22%' }}>
                      <Text style={{ fontSize:10}}>{product.artist}</Text>
                    </View>
                    <View style={{ width: '38%' }}>
                      <Text style={{ fontSize:10}}>Illustration</Text> 
                    </View>
                    <View style={{ width: '40%' }}>
                      <Text style={{ fontSize:10}}>{product.price}</Text>
                    </View>
