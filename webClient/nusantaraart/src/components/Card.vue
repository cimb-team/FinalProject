<template>
  ...
  >
    <div class="card-header" style="height:47px">{{ product.title }}</div>
          <div
    ...
    <div class="card-body" style="color:black">
      <ul class="list-group list-group-flush">
        <li class="list-group-item" style="border-radius:10px;margin-bottom:5px;background-color:lightgrey">Category: {{ product.category }}</li>
        <li class="list-group-item" style="border-radius:10px;margin-bottom:5px">{{ product.details }}</li>
